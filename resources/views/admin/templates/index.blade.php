...
<head>
    ...
    <!-- Sweet Alert -->
    <link type="text/css" href="{{ asset('volt') }}/assets/vendor/sweetalert2/dist/sweetalert2.min.css"
        rel="stylesheet">
...
<body>
    <main class="content">
        ...
        <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
            <a class="navbar-brand me-lg-5" href="{{ asset('volt') }}/index.html">
                <img class="navbar-brand-dark" src="{{ asset('volt') }}/assets/img/brand/light.svg"
                    alt="Volt logo" />
                <img class="navbar-brand-light" src="{{ asset('volt') }}/assets/img/brand/dark.svg"
                    alt="Volt logo" />
            </a>
            <div class="d-flex align-items-center">
            ...
            <div class="sidebar-inner px-4 pt-3">
                ...
                <ul class="nav flex-column pt-3 pt-md-0">
                    ...
                    <li class="nav-item  active ">
                        <a href="{{ asset('volt') }}/pages/dashboard/dashboard.html" class="nav-link">
                            <span class="sidebar-icon">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="multi-level collapse " role="list" id="submenu-app" aria-expanded="false">
                            <ul class="flex-column nav">
                                <li class="nav-item ">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/tables/bootstrap-tables.html">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="multi-level collapse " role="list" id="submenu-pages" aria-expanded="false">
                            <ul class="flex-column nav">
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/examples/sign-in.html">
                                        <span class="sidebar-text">Sign In</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/examples/sign-up.html">
                                        <span class="sidebar-text">Sign Up</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/examples/forgot-password.html">
                                        <span class="sidebar-text">Forgot password</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/examples/reset-password.html">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="multi-level collapse " role="list" id="submenu-components" aria-expanded="false">
                            <ul class="flex-column nav">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/components/buttons.html">
                                        <span class="sidebar-text">Buttons</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/components/notifications.html">
                                        <span class="sidebar-text">Notifications</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/components/forms.html">
                                        <span class="sidebar-text">Forms</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/components/modals.html">
                                        <span class="sidebar-text">Modals</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link"
                                        href="{{ asset('volt') }}/pages/components/typography.html">
            ...
            <div class="row">
                <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
                    <p class="mb-0 text-center text-lg-start">© <span class="current-year"></span> <a
                            class="text-primary fw-normal" href="https://themesberg.com" target="_blank">MHS Soft</a>
                    </p>
                </div>
    ...
    <!-- Core -->
    <script src="{{ asset('volt') }}/assets/vendor/@popperjs/core/dist/umd/popper.min.js"></script>
    <script src="{{ asset('volt') }}/assets/vendor/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Vendor JS -->
    <script src="{{ asset('volt') }}/assets/vendor/onscreen/dist/on-screen.umd.min.js"></script>

    <!-- Slider -->
    <script src="{{ asset('volt') }}/assets/vendor/nouislider/distribute/nouislider.min.js"></script>

    <!-- Smooth scroll -->
    <script src="{{ asset('volt') }}/assets/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>

    <!-- Charts -->
    <script src="{{ asset('volt') }}/assets/vendor/chartist/dist/chartist.min.js"></script>
    <script src="{{ asset('volt') }}/assets/vendor/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js">
    </script>

    <!-- Datepicker -->
    <script src="{{ asset('volt') }}/assets/vendor/vanillajs-datepicker/dist/js/datepicker.min.js"></script>

    <!-- Sweet Alerts 2 -->
    <script src="{{ asset('volt') }}/assets/vendor/sweetalert2/dist/sweetalert2.all.min.js"></script>
    ...
    <!-- Notyf -->
    <script src="{{ asset('volt') }}/assets/vendor/notyf/notyf.min.js"></script>

    <!-- Simplebar -->
    <script src="{{ asset('volt') }}/assets/vendor/simplebar/dist/simplebar.min.js"></script>
