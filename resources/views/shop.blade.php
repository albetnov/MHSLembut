...
@section('title', 'Shop | MHS Soft Web')
@section('content')
    <!-- Start All Title Box -->
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        <div class="type-lb">
                                                            {!! $product->status_produk == 'paling_laku' ? '<p class="new">Paling Laku</p>' : '' !!}
                                                            {!! $product->status_produk == 'paling_disukai' ? '<p class="new">Paling Disukai</p>' : '' !!}
                                                            {!! $product->status_masa == 'baru' ? '<p class="new">Baru</p>' : '' !!}
                                                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                    <div class="product-categori">
                        <div class="search-product">
                            <form action="{{ route('shop_search') }}" method="POST">
                                @csrf
